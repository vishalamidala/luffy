...
const SpinningIcoSphere = (props: any) => {
  ...
  useClick(
    () => setRotationY((current: any) => current + rotationDelta),
    icoSphereRef
  );
  ...
  useBeforeRender((scene) => {
    if (icoSphereRef.current) {
      ...
      icoSphereRef.current.rotation.y +=
